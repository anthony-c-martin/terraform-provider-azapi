...
```
[Warning use-secure-value-for-secure-inputs] Property 'adminPassword' expects a secure value, but the value provided may not be secure.
[Warning adminusername-should-not-be-literal] Property 'adminUserName' should not use a literal value. Use a param instead. Found literal string value "myadmin"
```
...
```
[Warning use-secure-value-for-secure-inputs] Property 'adminPassword' expects a secure value, but the value provided may not be secure.
[Warning adminusername-should-not-be-literal] Property 'adminUserName' should not use a literal value. Use a param instead. Found literal string value "testUser"
```
